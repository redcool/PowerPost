Shader "Hidden/Universal Render Pipeline/UberPostEx"
{
    HLSLINCLUDE
        ...
        half4 FragUberPost(Varyings input) : SV_Target
        {
            ...
            // keep sourceTex
            half4 c = SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, SCREEN_COORD_REMOVE_SCALEBIAS(uvDistorted));
            half3 color = c.xyz;
            half alpha = c.w;
