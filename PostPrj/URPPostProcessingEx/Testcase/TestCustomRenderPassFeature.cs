...
public class TestCustomRenderPassFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            //Blit(cmd,colorId, sceneColorRTId, mat, 0);

            //cmd.BlitColorDepth(colorId, sceneColorRTId, depthId, mat, 0);
            cmd.SetGlobalTexture("_MainTex",colorId);
            cmd.SetRenderTarget(sceneColorRTId, depthId);
            cmd.DrawMesh(CommandBufferEx.FullscreenQuad, Matrix4x4.identity, mat, 0, 0);

            //cmd.Blit(sceneColorRTId, colorId);
            Blit(cmd, sceneColorRTId, colorId);
    ...
    {
        m_ScriptablePass.colorId = renderer.cameraColorTarget;
        m_ScriptablePass.depthId = renderer.cameraDepthTarget;
